...
public class WRLImpl extends WiiRemoteAdapter
{
    ...
    public static void main(String args[])
    {
      ...
      try
      {
        /*WiiDeviceDiscoveryListener listener = new WiiDeviceDiscoveryListener()
        {
          public void wiiRemoteDiscovered(WiiDeviceDiscoveredEvent evt)
          {
            evt.getWiiDevice().getBluetoothAddress()addWiiRemoteListener(new WRLImpl(evt.getWiiRemote()));
          }
        ...
        AudioInputStream audio = AudioSystem.getAudioInputStream(new java.io.File("resources/sounds/audio8.wav"));
